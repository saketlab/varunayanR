...
We can check how well
[ERA5](https://cds.climate.copernicus.eu/datasets/reanalysis-era5-single-levels?tab=overview)
and [CRU TS](https://crudata.uea.ac.uk/cru/data/hrg/) agree for monthly
temperature over India. These are two independent records covering
2000-2018:

- **ERA5** - ECMWF reanalysis at 0.25°, pulled with `era5ify_bbox`
- **CRU TS v4.07** - station-interpolated observations from UEA at 0.5°,
  pulled with `cru_ts_bbox`
...
![](cru-ts-comparison_files/figure-html/monthly_ts-1.png)
...
![](cru-ts-comparison_files/figure-html/scatter-1.png)
...
![](cru-ts-comparison_files/figure-html/seasonal-1.png)

## Spatial bias map

To compare grid cell by grid cell, we snap ERA5 (0.25°) onto the CRU TS
0.5° grid and look at the difference:
...
![](cru-ts-comparison_files/figure-html/spatial_bias-1.png)
...
![](cru-ts-comparison_files/figure-html/annual_trend-1.png)
...
CRU TS is the simpler choice when you need long historical baselines
without CDS credentials, or monthly land-only temperature is enough.
ERA5 wins when you need sub-monthly frequency, ocean coverage, or
variables beyond temperature.
