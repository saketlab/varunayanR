...
```{r, include = FALSE}
# ponytail: eval=FALSE — needs live CDS API; CI with CDS_API_KEY can override
...
The helper function `GetERA5DailyHeatIndexData()` downloads temperature, dewpoint, and wind data
