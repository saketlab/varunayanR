...
Annual TXx (hottest day) for India: spatial mean across grid cells, with a
10-year running mean trend.
...
Monthly TXx averaged over 1981-2018 shows the typical pre-monsoon peak in
May-June and the cooler post-monsoon period.
