...
averages. We get all of that from one call, instead of finding boundaries,
writing GeoJSON, calling `era5ify_geojson()`, and aggregating grid cells by hand.

Here we pull monthly mean, max, and min temperatures for four European and four South Asian
countries in 2024.
