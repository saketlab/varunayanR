...
# ponytail: eval=FALSE — no pre-built .rds; needs live CDS + IMD; CI sets eval via CDS_API_KEY
...
[BharatViz](https://bharatviz.saketlab.org) renders choropleth maps of India from district-level data.
