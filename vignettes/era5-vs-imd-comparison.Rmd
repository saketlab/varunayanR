...
if (!file.exists(districts_file)) download.file(districts_url, districts_file, mode = "wb")
...
imd_districts <- join_to_districts(imd_mean_spatial, "temp", districts_sf)
...
```{r bharatviz_maps, fig.width=10, fig.height=6}
library(R6)
library(gridExtra)
...
# Generate district-level maps using LGD boundaries
