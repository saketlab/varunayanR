...
Downloads ERA5 temperature, dewpoint, and wind data for a region and
calculates all heat stress indices (relative humidity, wet bulb
temperature, heat index, WBGT, UTCI, and humidex).
